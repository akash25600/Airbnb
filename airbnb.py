...
def datafr():
    df= pd.read_csv("c:/Users/ELCOT/Desktop/airbnb data/Airbnb.csv/airbnb_pr.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("c:/Users/ELCOT/Desktop/airbnb data/airbnb.1.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("c:/Users/ELCOT/Desktop/airbnb data/Airbnb.csv/airbnb_pr.csv")
            return df_a
